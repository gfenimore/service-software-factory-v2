...
class FactoryExecutor {
    ...
    loadConfig() {
        const configPath = path.join(__dirname, '../1-inputs/config/factory-standards.yaml');
...
╚════════════════════════════════════════════╝
    ...
    getInputPath(subModuleId, line, processor) {
        ...
        if (line === 'concept' && processor === 'STORY-BUILDER') {
            ...
            return path.join(__dirname, '../../1-inputs/requirements/1.1-modules/account-management/1.1.1-sub-modules/master-view');
