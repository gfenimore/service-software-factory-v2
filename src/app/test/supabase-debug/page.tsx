  ...
  useEffect(() => {
    async function testConnection() {
      ...
      try {
        ...
        console.log('Anon key in client:', process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY?.substring(0, 10), '...')
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="text-xs text-gray-600">
                  Key preview: {status.env?.keyPreview}
                </div>
              </div>
            </div>
            ...
            {status.contactsForAccount && (
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div>Status: {status.contactsForAccount.success ? '✅ Success' : '❌ Failed'}</div>
